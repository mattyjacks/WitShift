        ...
        <section className="max-w-5xl mx-auto px-4 py-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              { icon: Users, title: "Focused Forum", desc: "Only 10 debaters & 25 messages keep things concise." },
              { icon: Mic2, title: "OpenAI Transcription", desc: "High-accuracy speech-to-text with OpenAI Whisper preserves content." },
              { icon: ShieldCheck, title: "Safety from Hate", desc: "Automated moderation shields you from hateful content." },
